...
namespace ScreenshotLikeAMac.ShotWindow
{
    ...
    public static class MouseHook
    {
        ...
        public static event EventHandler MouseLeftDownAction = delegate { };
        public static event EventHandler MouseLeftUpAction = delegate { };
